...
from devangana import pbot
from devangana.helper_extra.dbfun import get_couple, save_couple
...
{c1_mention} Weds {c2_mention} = 😘\nകല്യാണം :- നാളെ രാവിലെ 10:00 നും 10:10 നും ഇടക്കുള്ള ശുഭമുഹൂർത്തത്തിൽ . \nഎല്ലാരും വരണം . 
