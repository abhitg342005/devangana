...
from devangana.events import register

from devangana import LOGGER, TEMP_DOWNLOAD_DIRECTORY


from devangana import telethn as bot
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./devangana/resources/default.ttf"
