...
import devangana.modules.sql.notes_sql as sql
from devangana import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from devangana.__main__ import DATA_IMPORT
from devangana.modules.helper_funcs.chat_status import user_admin
from devangana.modules.helper_funcs.alternate import typing_action

# from devangana.modules.rules import get_rules
import devangana.modules.sql.rules_sql as rulessql

# from devangana.modules.sql import warns_sql as warnssql
import devangana.modules.sql.blacklist_sql as blacklistsql
from devangana.modules.sql import disable_sql as disabledsql

# from devangana.modules.sql import cust_filters_sql as filtersql
# import devangana.modules.sql.welcome_sql as welcsql
import devangana.modules.sql.locks_sql as locksql
from devangana.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("devangana{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("devangana{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `devangana-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("devangana{}.backup".format(chat_id))  # Cleaning file
