...
import devangana.modules.sql.global_bans_sql as sql
from devangana.modules.sql.users_sql import get_user_com_chats
...
from devangana.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_text("അടിച്ചു ഇറക്കി വിട്ടിട്ടുണ്ട് .ഇനി കയറണം എങ്കിൽ @ANIYATHIKUTTIEEDE_CHECHIKUTTI യെ  contact ചെയ്യ്")
