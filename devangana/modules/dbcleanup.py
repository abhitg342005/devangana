...
import devangana.modules.sql.global_bans_sql as gban_sql
import devangana.modules.sql.users_sql as user_sql
from devangana import DEV_USERS, OWNER_ID, dispatcher
