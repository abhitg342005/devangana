...
from devangana.modules import ALL_MODULES
from devangana.modules.helper_funcs.chat_status import is_user_admin
from devangana.modules.helper_funcs.misc import paginate_modules
...
*ʜᴇʏ,\n ᴛʜɪs ɪs {}* [!](https://telegra.ph/file/9053380e30ba23bbd9d21.jpg)\n\n 𝙆𝙐𝙍𝙐𝙆𝙎𝙃𝙀𝙏𝙍𝘼 \n\n This is a Social Media Friendship Gang with Ultra strong Bond of Lots of Love💞 . We always Try to bring forward the New ideas to  front of the members . We consider our members all are our Family Members . 
 ...
 🖥  @Abhi34200
 🎭  @Bloodysweeett
 🕺  @Rocky_bhai_officiall
 💃🏾  @Exnos_TG_33

✍🏾Channel :- @about_abhiiii
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="💞Music player💞", url=f"https://t.me/Stenzle_MariaMbot?startgroup=true",
        ),
    ],
]

GroupManager_IMG = "hhttps://telegra.ph/file/c15650d6e993e4a9a3e9c.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("devangana.modules." + module_name)
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/c15650d6e993e4a9a3e9c.jpg",
                caption=f"""
...
ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [༂𖤓࿈കൃഷ്ണ🦋തുളസ᭄🌙⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ࿈𖤓༂](https://t.me/{OWNER_USERNAME})""",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
